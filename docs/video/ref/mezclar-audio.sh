...
#   ./mezclar-audio.sh renders/video.mp4 renders/normi-short-03.mp4
set -euo pipefail
IN="${1:-renders/video.mp4}"
OUT="${2:-renders/normi-short-03.mp4}"
FX="/tmp/normi02-efectos.wav"

BGM="assets/bgm/cama-34s.wav"
...
G_SOPLO=-3; G_CUERPO=-7; G_SUAVE=-9; G_THUD=-8; G_BRILLO=-8; G_BGM=-11
