...
k = dict(
 ...
 normi2=t(4,"normi",0.02), formmy=t(4,("formmy","formie","formi"),0.12*D[4]), denik=t(4,("denik","the","deni"),0.22*D[4]), flota=t(4,"flota",0.4*D[4]), easy5=t(4,("isibits","easybits","ysi","isi"),0.5*D[4]), agentes=t(4,"agentes",0.58*D[4]), software=t(4,("aplicaciones","software"),0.7*D[4]), entra=t(4,"entra",0.82*D[4]), cloud=t(4,("cloud","yacybits","easybits.","isibits"),0.97*D[4]),
)
