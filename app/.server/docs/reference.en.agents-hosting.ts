...
\`EASYBITS_DB_URL\` is already in the environment of an \`eve-nitro\` box created with \`POST /sandboxes\`; no need to pass it in \`env\` (you do need it on a box made by forking a snapshot — section 3).
