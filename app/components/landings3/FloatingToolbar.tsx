...
const STYLE_PRESETS = [
  { label: "Minimal", icon: "○", instruction: "Rediseña esta sección con estética minimal: mucho espacio en blanco, tipografía limpia, sin bordes ni sombras innecesarias. Mantén el mismo contenido." },
  { label: "Cards", icon: "▦", instruction: "Rediseña esta sección usando layout de cards en grid: cada item en su propia card con padding, sombra sutil y bordes redondeados. Mantén el mismo contenido." },
  { label: "Bold", icon: "■", instruction: "Rediseña esta sección con estilo bold/brutalist: tipografía grande y gruesa, colores de alto contraste, bordes sólidos, sin gradientes. Mantén el mismo contenido." },
  { label: "Glass", icon: "◇", instruction: "Rediseña esta sección con glassmorphism: fondos translúcidos con backdrop-blur, bordes sutiles blancos, sombras suaves. Usa un fondo oscuro o con gradiente detrás. Mantén el mismo contenido." },
  { label: "Dark", icon: "●", instruction: "Rediseña esta sección con fondo oscuro (#111 o similar), texto claro, acentos de color vibrantes. Mantén el mismo contenido." },
];
      ...
      <div className="flex items-center gap-1.5">
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-1 flex-1">
          <input
            ...
            placeholder={refImage ? "Instrucción + imagen..." : "Editar con AI..."}
            disabled={isRefining}
        ...
        <div className="flex flex-col gap-1 pt-0.5 pb-0.5 border-t border-gray-700/50">
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="px-2 py-1 text-[10px] font-bold rounded bg-brand-500 hover:bg-brand-600 transition-colors shrink-0"
            >
              Set
            </button>
          </div>
