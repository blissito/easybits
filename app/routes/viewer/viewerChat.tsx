...
export const ChatMobile = () => {
  return (
    <section
      className={cn(
        "bg-onix h-full lg:hidden w-full grow rounded-2xl relative overflow-hidden",
...
export const Chat = () => {
  return (
    <section
      className={cn(
        "bg-onix hidden min-w-[300px] w-[300px] min-h-full rounded-r-2xl relative overflow-hidden",
        "lg:block"
      )}
    >
      <ChatHeader />
...
const ChatHistorial = () => {
  return (
    <div
      className={cn(
        "px-2 pt-1 pb-14 text-tale font-light h-full box-border mb-2",
        "md:px-4 md:pt-4"
      )}
    >
...
const ChatBox = () => {
  return (
    <div className="px-4 pb-4 absolute bottom-0 w-full flex ">
      <input
        className={cn(
