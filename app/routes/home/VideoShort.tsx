...
// Arranca solo y en silencio (autoplay solo se permite muted); un clic activa el audio.
const VIDEO_URL =
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-[5%] xl:px-0 py-16 md:py-24 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2 flex justify-center">
          <button
            ...
            className="relative block w-[300px] md:w-[340px] lg:w-[380px] aspect-[9/16] bg-black border-[4px] border-black shadow-[14px_14px_0_#111] cursor-pointer group"
          >
            <video
              ref={ref}
            ...
            <span
              className={
                "absolute left-3 bottom-3 flex items-center gap-2 bg-black text-[#D9FF3D] font-mono text-xs uppercase tracking-[0.18em] px-3 py-2 border-2 border-[#D9FF3D] transition-opacity " +
                (muted ? "opacity-100" : "opacity-0 group-hover:opacity-100")
              }
            >
              {muted ? "🔇 clic para oír" : "🔊 con sonido"}
            </span>
          </button>
      </div>
    </section>
