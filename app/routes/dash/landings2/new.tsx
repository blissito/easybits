...
export const meta = () => [
  { title: "Nueva Landing v2 — EasyBits" },
...
export const action = async ({ request }: Route.ActionArgs) => {
  ...
  return redirect(`/dash/landings2/${landing.id}?generating=1`);
};
        ...
        <div>
          ...
          <BrutalField>
            <textarea
              ...
              required
              rows={4}
              placeholder="Describe tu landing: un evento, un producto, una comunidad..."
